...
export default function Experience() {
  return (
    ...
    >
      ...
      >
        Here’s what I’ve done in real-world environments — from backend to
      ...
      >
        ...
        <ul className="list-disc list-inside  text-sm space-y-1">
          <li>
            Developed a full CRUD notes system using PHP, SQL & AJAX with
            real-time updates.
          </li>
          <li>
          ...
          <li>
            Designed Tailwind-responsive UI + added UX animations using Framer
            Motion.
          </li>
          <li>
