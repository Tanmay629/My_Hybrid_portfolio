...
const skills = [
  {
    ...
    projects: 8,
    proficiency: 80,
    description: "Declarative UI framework for modern web applications.",
  },
  {
    name: "JavaScript ES6+",
    category: "Frontend",
    projects: 15,
    proficiency: 88,
    description: "Core language for interactive and dynamic web experiences.",
  },
  {
    name: "Tailwind CSS",
    category: "Frontend",
    projects: 8,
    proficiency: 90,
    description: "Utility-first CSS framework for rapid and custom UI design.",
  },
  {
    name: "Framer Motion",
    category: "Frontend",
    ...
    proficiency: 80,
    description:
      "React animation library for fluid and engaging user interfaces.",
  },
  ...
  },
  {
    ...
    proficiency: 67,
    description:
      "Minimalist web framework for creating robust APIs with Node.js.",
  },
  {
    name: "PHP",
    category: "Backend & APIs",
    projects: 6,
    proficiency: 78,
    description: "Server-side scripting language for dynamic web development.",
  },
  {
    name: "REST API",
    category: "Backend & APIs",
    projects: 9,
    proficiency: 73,
    description: "Designing and implementing scalable, stateless web services.",
  },
  {
    ...
    proficiency: 78,
    description:
      "Implementing token-based security for stateless user authentication.",
  },
  ...
  },
  {
    ...
    proficiency: 80,
    description:
      "Relational database system for structured and reliable data management.",
  },

  {
    ...
    proficiency: 89,
    description:
      "Version control system for collaborative and efficient code management.",
  },
  {
    name: "UI/UX Design",
    category: "Development Tools",
    ...
    proficiency: 82,
    description:
      "Applying user-centered principles for intuitive and effective interfaces.",
  },
];
...
export default function Skills() {
  ...
  return (
    ...
    >
      ...
      >
        A showcase of my core competencies, from frontend design to backend
      ...
      >
        {filteredSkills.map((skill) => (
          <motion.div key={skill.name} className="glass-card p-5 relative">
            ...
            <div className="w-full h-2 bg-zinc-200 dark:bg-gray-900 rounded-full mb-3 relative overflow-hidden">
              <motion.div
